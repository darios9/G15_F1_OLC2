...
function peg$parse(input, options) {
  ...
  var peg$e2 = peg$otherExpectation("agrupada");
  ...
  var peg$e17 = peg$classExpectation([["0", "9"], "_"], false, false);
  var peg$e18 = peg$otherExpectation("identificador");
  var peg$e19 = peg$otherExpectation("espacios en blanco");
  var peg$e20 = peg$classExpectation([" ", "\t", "\n", "\r", "\f"], false, false);

  var peg$f0 = function(c) {
  console.log(c.join(''))
};
  var peg$f1 = function(r) {
  console.log(`ENCADENADO: ${r}`);
};
  var peg$f2 = function(i, f) { 
  console.log(`RI: ${i} RF: ${f}`)};
  var peg$f3 = function(i, f) {
  console.log(`INICIO: ${i} FINAL: ${f}`);
  };
  var peg$f4 = function() { console.log(text())};
  ...
  function peg$parseinstanciaAgr() {
  ...
  function peg$parserangoContenido() {
    var s0, s1, s2, s3, s4, s5, s6, s7;
